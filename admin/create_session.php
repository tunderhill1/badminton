...
?>
	...
	function updateTimeFields(time){
		...
		case "3":
			...
			document.getElementById('endmin').value = "00";
			document.getElementById('location').value = "Ethos";
			document.getElementById('places').value = "0";
			document.getElementById('managers').value = "0";
			document.getElementById('trad').value = "Coaching session. Book in advance via union shop (https://tinyurl.com/yuyf7a9j). Limited availability";
			break;
		}
	}
	</script>
    ...
    <div class="container">
		...
		<div class="row uniform">
			<ul class="actions">
				...
				<li><button class="button alt" onclick="updateTimeFields('3');">3 Thurs (Coaching)</button></li>
			</ul>
		</div>
