        ...
        <div class="row uniform">
            <div class="6u 12u$(small)">
                <ul>
                    ...
                    <li>You can also book 1 Sunday (coaching) session.</li>
                    <li>sessions are locked <b><?php   echo SESSION_LOCKING_TIME / 60; ?> minutes</b> before they start.</li>
                    <li>There is a <a href="#" onclick="openPenaltyModal()">penalty system</a> in place!</li>
                </ul>
                <hr>
                <p>
                    Our Sunday coaching sessions will be run by team members to help you improve your game. These are also a great way to see what the <a href="<?php   echo SITE_URL; ?>/about/">Social Team</a> could be like.
                    <span class="training-cost">The cost to attend each of these sessions is £5.</span>
                </p>
                <hr>
                <p>
