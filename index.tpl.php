...
<?php
    ...
    <header class="major special">
        ...
        <ul class="icons">
            <li>
                <a href="https://www.facebook.com/groups/212736565421688" class="icon fa-facebook" target="_blanck">
                    <span class="label">Facebook</span>
                </a>
            </li>
            <li>
                <a href="https://www.instagram.com/icbadminton" class="icon fa-instagram" target="_blanck">
                    <span class="label">Instagram</span>
                </a>
            </li>
            <li>
                <a href="mailto:badminton@imperial.ac.uk" class="icon fa-envelope" target="_blanck">
    ...
    <div class="inner">
        ...
        <article class="feature left">
            ...
            <div class="content">
                ...
                <p>To pay for coaching sessions, go to our <a href="https://www.imperialcollegeunion.org/shop/student-groups/382" target="_blank">union shop</a></p>
            </div>
        </article>
        <article class="feature right">
            <span class="image"><img src="<?php   echo SITE_URL; ?>/images/Ice Skating NHM 2021.jpeg"></span>
            <div class="content">
                <h2>Social Events</h2>
                <p>From our Welcome Dinner to our club favourite Karaoke, we hold social events throughout the year!</p>
                <p>Join our <a href="https://www.facebook.com/groups/212736565421688" target="_blanck">Facebook group</a> to be updated about any upcoming events.</p>
            </div>
        </article>
    </div>
</section>
